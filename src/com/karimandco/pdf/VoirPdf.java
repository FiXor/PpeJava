...
public class VoirPdf extends javax.swing.JPanel {
    ...
    private String nom = com.karimandco.auth.Utilisateur.getInstance().nom;
    private String prenom = com.karimandco.auth.Utilisateur.getInstance().prenom;
    private String numero = com.karimandco.auth.Utilisateur.getInstance().numeroTelephone;
    ...
    public VoirPdf() {
        initComponents();
        nom = com.karimandco.auth.Utilisateur.getInstance().nom;
        prenom = com.karimandco.auth.Utilisateur.getInstance().prenom;
        numero = com.karimandco.auth.Utilisateur.getInstance().numeroTelephone;
        lienPDF = "cv";
